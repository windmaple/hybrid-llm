...
const val USER_PREFIX = "user\nYou are an AI agent on mobile phones. Your goal is to help users finish specific tasks on phones.\n" +
        "\n" +
        "You have access to the following tools:\n" +
        "\n" +
        "* `increase_volume(volume)`: increase the phone's volume\n" +
        "* `dim_screen()`: dim the phone's screen\n" +
        "* `call_gemimi_api(prompt)`: call the Gemini API to answer the question\n" +
        "\n" +
